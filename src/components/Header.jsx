        ...
        <header className="absolute inset-x-0 top-0 z-50">
            <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    <NavLink to="/" className="text-sm/6 font-semibold text-white">Home</NavLink>
                    <NavLink to="/users" className="text-sm/6 font-semibold text-white">Users</NavLink>
                    <NavLink to="/posts" className="text-sm/6 font-semibold text-white">Posts</NavLink>
                </div>
                            ...
                            <div className="mt-6 flow-root">
                                <div className="-my-6 divide-y divide-white/10">
                                    <div className="space-y-2 py-6">
                                        <NavLink to="/" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Home</NavLink>
                                        <NavLink to="/users" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Users</NavLink>
                                        <NavLink to="/posts" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Posts</NavLink>
                                    </div>
                                    <div className="py-6">
